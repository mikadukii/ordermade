...
const EditServices = () => {
    ...
    const fetchContent = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:3000/api/get-services/${id}`, {
            ...
            if (response.data.success) {
                ...
                setThumbnailPreview('https://localhost:3000${thumbnailUrl}');
            }
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:5000/api/edit-services//${id}`, formDataToSend, {
                headers: { Authorization: `Bearer ${token}` },
            });
